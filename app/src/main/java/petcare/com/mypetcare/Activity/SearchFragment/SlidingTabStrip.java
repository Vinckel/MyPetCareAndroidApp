...
class SlidingTabStrip extends LinearLayout {
    ...
    private static final int DEFAULT_SELECTED_INDICATOR_COLOR = 0xFFFFFFF;
...
//        final int themeForegroundColor =  Color.parseColor("#FFFFFF");
...
//                    height, mSelectedIndicatorPaint);
            canvas.drawCircle((left + right) / 2, (height - mSelectedIndicatorThickness - 10) , mSelectedIndicatorThickness, mSelectedIndicatorPaint);
        }
